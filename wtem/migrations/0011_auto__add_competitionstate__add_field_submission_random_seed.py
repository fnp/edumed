...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompetitionState'
        db.create_table(u'wtem_competitionstate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=16)),
        ))
        db.send_create_signal(u'wtem', ['CompetitionState'])

        # Adding field 'Submission.random_seed'
        db.add_column(u'wtem_submission', 'random_seed',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CompetitionState'
        db.delete_table(u'wtem_competitionstate')

        # Deleting field 'Submission.random_seed'
        db.delete_column(u'wtem_submission', 'random_seed')
