...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MarkCriterion'
        db.create_table(u'stage2_markcriterion', (
        ...
        db.send_create_signal(u'stage2', ['MarkCriterion'])

        # Adding unique constraint on 'MarkCriterion', fields ['assignment', 'order']
        db.create_unique(u'stage2_markcriterion', ['assignment_id', 'order'])

        # Adding field 'Mark.criterion'
        db.add_column(u'stage2_mark', 'criterion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['stage2.MarkCriterion']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'MarkCriterion', fields ['assignment', 'order']
        db.delete_unique(u'stage2_markcriterion', ['assignment_id', 'order'])

        # Deleting model 'MarkCriterion'
        db.delete_table(u'stage2_markcriterion')

        # Deleting field 'Mark.criterion'
        db.delete_column(u'stage2_mark', 'criterion_id')
    ...
    models = {
        ...
        u'stage2.mark': {
            'Meta': {'unique_together': "(['expert', 'criterion'],)", 'object_name': 'Mark'},
            'answer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['stage2.Answer']"}),
