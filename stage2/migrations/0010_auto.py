...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field supervisors on 'Assignment'
        m2m_table_name = db.shorten_name(u'stage2_assignment_supervisors')
    ...
    def backwards(self, orm):
        # Removing M2M table for field supervisors on 'Assignment'
        db.delete_table(db.shorten_name(u'stage2_assignment_supervisors'))
