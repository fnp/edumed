...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.need_arbiter'
        db.add_column(u'stage2_answer', 'need_arbiter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.need_arbiter'
        db.delete_column(u'stage2_answer', 'need_arbiter')
