...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field arbiters on 'Assignment'
        m2m_table_name = db.shorten_name(u'stage2_assignment_arbiters')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('assignment', models.ForeignKey(orm[u'stage2.assignment'], null=False)),
    ...
    def backwards(self, orm):
        # Removing M2M table for field arbiters on 'Assignment'
        db.delete_table(db.shorten_name(u'stage2_assignment_arbiters'))
    ...
    models = {
        ...
        u'stage2.assignment': {
            ...
            'arbiters': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'stage2_arbitrated'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
