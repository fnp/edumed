...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field experts on 'Answer'
        m2m_table_name = db.shorten_name(u'stage2_answer_experts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('answer', models.ForeignKey(orm[u'stage2.answer'], null=False)),
    ...
    def backwards(self, orm):
        # Removing M2M table for field experts on 'Answer'
        db.delete_table(db.shorten_name(u'stage2_answer_experts'))
