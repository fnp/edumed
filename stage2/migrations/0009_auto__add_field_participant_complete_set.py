...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.complete_set'
        db.add_column(u'stage2_participant', 'complete_set',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.complete_set'
        db.delete_column(u'stage2_participant', 'complete_set')
