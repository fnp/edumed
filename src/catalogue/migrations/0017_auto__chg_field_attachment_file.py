...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'catalogue_attachment', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Attachment.file'
        db.alter_column(u'catalogue_attachment', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
